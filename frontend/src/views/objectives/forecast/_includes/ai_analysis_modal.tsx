...
const AiAnalysisModal = (props: {
  ...
  const { sendMessage, lastMessage, readyState } = useWebSocket(
    ...
    {
      shouldReconnect: (closeEvent) => true, // eslint-disable-line @typescript-eslint/no-unused-vars
    }
  );

  const KEYS_TO_SETTERS: Record<
    string,
  ...
  return (
    <Modal
      isOpen={props.isOpenTrendModal}
      onClose={props.onCloseTrendModal}
      size="6xl"
    >
      <ModalOverlay />
      <ModalContent>
                ...
                return (
                  ...
                  >
                    <Stack>
                      ...
                      <Heading mt="unset !important" size="xl">
                        {props.chartFilter[filter_key]}
                      </Heading>
                    </Stack>
                  </Box>
                );
