      ...
      >
        <FormControl isRequired>
          ...
          <InputGroup justifyContent="space-between" alignItems="center">
            <Input
              width="49%"
              onChange={(e) => props.setS3DataBucket(e.currentTarget.value)}
              placeholder="Name of the S3 bucket containing your source data"
            />
            <Text fontSize="2xl">/</Text>
            <Input
              width="49%"
              onChange={(e) => props.setRawSourcePath(e.currentTarget.value)}
              placeholder="Path to the source data files in your S3 Bucket"
            />
          </InputGroup>
        </FormControl>
        <FormControl isRequired>
          ...
          <Input
            onChange={(e) => props.setSourceName(e.currentTarget.value)}
