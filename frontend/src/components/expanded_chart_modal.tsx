import { Box, Button, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Spinner, Stack, Text } from "@chakra-ui/react"
...
const ExpandedChartModal = (props: {
    ...
    return (
        <Modal size="6xl" isOpen={props.isOpenExpandedChartModal} onClose={props.onCloseExpandedChartModal}>
            <ModalOverlay />
            <ModalContent>
