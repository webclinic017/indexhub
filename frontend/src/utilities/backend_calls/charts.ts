...
export const getSegmentationChart = async (
  ...
  const get_segmentation_chart_response = await fetch(
    get_segmentation_chart_url,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const getCombinedEntitiesAndInventoryChart = async (
  ...
  const get_combined_entities_and_inventory_chart_response = await fetch(
    get_combined_entities_and_inventory_chart_url,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  const response_json =
    await get_combined_entities_and_inventory_chart_response.json();
  return JSON.parse(response_json);
};
