export const createSource = async (user_id: string, source_name: string, raw_data_path: string, freq: string, s3_data_bucket: string, time_col: string, entity_cols: string[], target_cols: string[], access_token_indexhub_api:string) => {
...
export const deleteSource = async (access_token_indexhub_api:string, source_id: string) => {
...
export const getSource = async (user_id = "", source_id = "", access_token_indexhub_api:string) => {
  let get_source_url = ""
...
export const getSourceColumns = async (s3_data_bucket: string, raw_source_path: string, access_token_indexhub_api: string) => {
