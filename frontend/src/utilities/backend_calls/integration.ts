...
export const getUserIntegrations = async (
    ...
    const get_user_credentials_url = `${process.env.REACT_APP__FASTAPI__DOMAIN}/integrations/${user_id}`;
...
export const setUserIntegrations = async (
    ...
    const set_user_integrations_url = `${process.env.REACT_APP__FASTAPI__DOMAIN}/integrations/${user_id}`;
